...
export const getExpenses = async (
  ...
  if (!options?.type) {
    expensesRef = expensesRef.orderBy("expense_type");
  }
...
export const getExpenseTotalsByType = async (
  type,
  startDate = null,
  endDate = null
) => {
...
export const getExpenseTotalsAggregate = async (
  startDate = null,
  endDate = null
) => {
  let db = firebase.firestore();
...
export const getExpenseTotalsAggregateByDate = async (
  startDate = null,
  endDate = null,
  filterByType = null
) => {
