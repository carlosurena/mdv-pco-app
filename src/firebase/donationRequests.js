...
export const getDonations = async (
  ...
  if (options.limit != null) {
    ...
    donationsRef = donationsRef.limit(options.limit);
  }
...
export const getDonationTotalsByPerson = async (
  id,
  startDate = null,
  endDate = null
) => {
...
export const getDonationTotalsAggregate = async (
  startDate = null,
  endDate = null
) => {
  let db = firebase.firestore();
    ...
    .then((donations) => {
      ...
      dbData.reduce(function (res, value) {
        if (!res[value.donor_pco_id]) {
          res[value.donor_pco_id] = {
            donor_pco_id: value.donor_pco_id,
            type: "donation",
...
export const getDonationTotalsAggregateByDate = async (
  startDate = null,
  endDate = null,
  filterByType = null
) => {
