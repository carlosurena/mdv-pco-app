    ...
    <div>
      ...
      <Tabs defaultValue="delete">
        <Tabs.List>
          ...
          <Tabs.Tab value="coming_soon" disabled icon={<Settings size={14} />}>
            {t("coming_soon")}
          </Tabs.Tab>
        </Tabs.List>
            ...
            <div>
              ...
              {dt.map((item) => {
                return (
                  <div>
                    <Button
                      onClick={() => handleItemDelete("dt", item.id)}
                      leftIcon={<TrashX />}
                      variant="white"
                      color="red"
                    >
            ...
            <div>
              ...
              {ds.map((item) => {
                return (
                  <div>
                    <Button
                      onClick={() => handleItemDelete("ds", item.id)}
                      leftIcon={<TrashX />}
                      variant="white"
                      color="red"
                    >
            ...
            <div>
              ...
              {et.map((item) => {
                return (
                  <div>
                    <Button
                      onClick={() => handleItemDelete("et", item.id)}
                      leftIcon={<TrashX />}
                      variant="white"
                      color="red"
                    >
            ...
            <div>
              ...
              {em.map((item) => {
                return (
                  <div>
                    <Button
                      onClick={() => handleItemDelete("em", item.id)}
                      leftIcon={<TrashX />}
                      variant="white"
                      color="red"
                    >
