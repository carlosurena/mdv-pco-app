	...
	const totals = 
		<tfoot>
			<tr>
				...
				{props.data && props.data.length > 0 && props.data[0].method && <th></th>}
				{props.data && props.data.length > 0 && props.data[0].donation_type && <th></th>}
				{props.data && props.data.length > 0 && props.data[0].source && <th></th>}
				...
				<Table>
					<thead>
						<tr>
							...
							{props.data[0].method && <th>{t('method')} {renderSorting}</th>}
							{props.data[0].donation_type && <th>{t('type')} {renderSorting}</th>} 
							{props.data[0].source && <th>{t('source')} {renderSorting}</th>} 
